...
Version  : 1.3
Release  : 28
URL      : https://mirrors.kernel.org/gnu/libunistring/libunistring-1.3.tar.gz
Source0  : https://mirrors.kernel.org/gnu/libunistring/libunistring-1.3.tar.gz
Source1  : https://mirrors.kernel.org/gnu/libunistring/libunistring-1.3.tar.gz.sig
Source2  : F5BE8B267C6A406D.pkey
...
grep -E '^\[GNUPG:\] (GOODSIG|EXPKEYSIG) F5BE8B267C6A406D' gpg.status
%setup -q -n libunistring-1.3
cd %{_builddir}/libunistring-1.3
pushd ..
cp -a libunistring-1.3 build32
popd
pushd ..
cp -a libunistring-1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729120847
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libunistring.so.5.2.0
...
/usr/lib32/libunistring.so.5.2.0
