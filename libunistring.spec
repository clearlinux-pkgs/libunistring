...
Version  : 1.2
Release  : 27
URL      : https://mirrors.kernel.org/gnu/libunistring/libunistring-1.2.tar.xz
Source0  : https://mirrors.kernel.org/gnu/libunistring/libunistring-1.2.tar.xz
Source1  : https://mirrors.kernel.org/gnu/libunistring/libunistring-1.2.tar.xz.sig
...
cd %{_builddir}/libunistring-1.2
pushd ..
cp -a libunistring-1.2 build32
popd
pushd ..
cp -a libunistring-1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708964963
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libunistring.so.5.1.0
/usr/lib64/libunistring.so.5
/usr/lib64/libunistring.so.5.1.0
